...
export const Announce = () => {
    return (
        <Box
            w={{ base: "100%" }}
            p={{ base: "1.5em 0", sm:'1.75em 0', md:'2em 0' }}
            bg={{ base: "pink.light"}}
            fontSize={{lg:'1.125em', xl:'1.0625em'}}
            fontStyle={{base:'italic'}}
        >
            <Text
                fontSize={{ base: "1.5em", md: "2em", xl:'4.5rem' }}
                textAlign={{base:'center'}}
                pb={{ base: "0.5em", sm: "1em", xl:'0'}}
            ...
            <Text
                textAlign={{base:'center'}}
                lineHeight={{ base: "1.5em", sm: "1.75em", md:'1.75em'}}
